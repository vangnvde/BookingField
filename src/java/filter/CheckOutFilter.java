 ...
 * @author Vang Nguyen
 */
@WebFilter(filterName = "CheckOutFilter", servletNames = {"confirmBookingInfo","ConfirmChangeUserInfo"})
public class CheckOutFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(url.contains("confirmBookingInfo") && user == null){
            httpRespond.sendRedirect("login");
        }else if(url.contains("confirmBookingInfo") && (user.isIsManager() || user.isIsAdmin())){
