...
import controller.common.GooglePojo;
import dao.UserDao;
...
import model.User;
import controller.common.GoogleUtils;
...
public class LoginGoogle extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (code == null || code.isEmpty()) {
            ...
            User user = new UserDao().checkLogin(googleUser.getEmail(), googleUser.getId());
            if (user == null) {
                user = new UserDao().addNewGoogleUser(googleUser.getEmail(),
                        googleUser.getId(),
                        googleUser.getName(),
                        googleUser.getEmail(),
